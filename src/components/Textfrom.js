    ...
    <>
        <div className="container" style={{color:props.mode==='dark'?'white':'#042743'}}>
            ...
            <div className="mb-3">
                ...
                <button className="btn btn-primary my-3 mx-2" onClick={changeUppercase} >UPPERCASE</button>
                <button className="btn btn-danger my-3 mx-2"  onClick={changeLowercase} >lowercase</button>
                <button className="btn btn-warning my-3 mx-2" onClick={changeclear} >Clear Text</button>
                <button className="btn btn-success my-3 mx-2" onClick={Capitalizedcase} >Capitalized Case</button>
                <button className="btn btn-danger my-3 mx-2" onClick={SentenceCase} >Sentence Case</button>
                <button className="btn btn-warning my-3 mx-2" onClick={copyText} >copy Text</button>
                <button className="btn btn-success my-3 mx-2" onClick={extraSpaces} >remove Extraspaces</button>
